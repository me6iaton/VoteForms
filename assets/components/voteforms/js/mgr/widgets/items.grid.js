VoteForms.grid.Items = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'voteforms-grid-items';
    }
    Ext.applyIf(config, {
    ...
    VoteForms.grid.Items.superclass.constructor.call(this, config);
...
Ext.extend(VoteForms.grid.Items, MODx.grid.Grid, {
    windows: {},
    ...
    createItem: function (btn, e) {
        var w = MODx.load({
            xtype: 'voteforms-item-window-create',
            id: Ext.id(),
            listeners: {
                success: {
                    fn: function () {
        ...
        MODx.Ajax.request({
            ...
            listeners: {
                success: {
                    fn: function (r) {
                        var w = MODx.load({
                            xtype: 'voteforms-item-window-update',
                            id: Ext.id(),
                            record: r,
                            listeners: {
                                success: {
...
Ext.reg('voteforms-grid-items', VoteForms.grid.Items);