...
$_lang['voteforms_prop_sortby'] = 'Поле для сортировки';
$_lang['voteforms_prop_sortdir'] = 'Направление сортировки';
$_lang['voteforms_prop_submit'] = 'Использовать кнопку отправить в форме';
$_lang['voteforms_prop_form'] = 'Id формы, обязательный параметр';
$_lang['voteforms_prop_resource'] = 'Id ресурса. По умолчанию текущий ресурс';
